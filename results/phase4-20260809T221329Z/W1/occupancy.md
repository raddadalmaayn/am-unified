...
|---|---|---|---|---|---|---|---|---|---|---|---|
| E r1 | 1 | 100 | 100 | 100 | 1.00 | 2.46 | 2.29 | 413.2 | 94.7 | 315.4 | yes |
| E r2 | 1 | 100 | 100 | 100 | 1.00 | 2.52 | 2.32 | 411.9 | 92.3 | 317.1 | yes |
| E r3 | 1 | 100 | 100 | 100 | 1.00 | 2.55 | 2.35 | 390.0 | 78.3 | 315.4 | yes |

### Median across runs, per condition

| Cond | W | tx/block | Block rate /s (steady win) | Block rate /s (total win) | Steady TPS | P50 ms |
|---|---|---|---|---|---|---|
| E | 1 | 1.00 | 2.52 | 2.34 | 2.32 | 411.9 |

### Hypothesis verdict

Condition E (W=20), median tx_per_block = **1.00**, median block_rate = **2.52/s**.

- Blocks carry roughly one transaction (tx_per_block < 2): **YES**
...
wrote am-unified/results/phase4-20260809T221329Z/W1/occupancy.md
