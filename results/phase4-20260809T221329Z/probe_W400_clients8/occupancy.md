...
|---|---|---|---|---|---|---|---|---|---|---|---|
| E r1 | 400 | 2000 | 2000 | 385 | 5.19 | 5.18 | 16.14 | 20661.1 | 437.1 | 20222.0 | yes |

### Median across runs, per condition

| Cond | W | tx/block | Block rate /s (steady win) | Block rate /s (total win) | Steady TPS | P50 ms |
|---|---|---|---|---|---|---|
| E | 400 | 5.19 | 5.18 | 3.66 | 16.14 | 20661.1 |

### Hypothesis verdict

Condition E (W=20), median tx_per_block = **5.19**, median block_rate = **5.18/s**.
...
wrote am-unified/results/phase4-20260809T221329Z/probe_W400_clients8/occupancy.md
