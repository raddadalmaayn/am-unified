...
|---|---|---|---|---|---|---|---|---|---|---|---|
| E r1 | 400 | 2000 | 2000 | 418 | 4.78 | 5.95 | 17.05 | 21998.1 | 450.1 | 21437.5 | yes |
| E r2 | 400 | 2000 | 2000 | 405 | 4.94 | 5.87 | 17.36 | 20254.7 | 410.0 | 19774.6 | yes |
| E r3 | 400 | 2000 | 2000 | 400 | 5.00 | 5.60 | 16.80 | 22191.8 | 390.7 | 21708.4 | yes |

### Median across runs, per condition

| Cond | W | tx/block | Block rate /s (steady win) | Block rate /s (total win) | Steady TPS | P50 ms |
|---|---|---|---|---|---|---|
| E | 400 | 4.94 | 5.87 | 3.64 | 17.05 | 21998.1 |

### Hypothesis verdict

Condition E (W=20), median tx_per_block = **4.94**, median block_rate = **5.87/s**.
...
wrote am-unified/results/phase4-20260809T221329Z/W400/occupancy.md
